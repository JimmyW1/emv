...
public class TerminalTag {
    ...
    //ICC tags: which is an issuer assigned value that is retained by the terminal
    public final static String tag9F45 = "9F45"; // Data Authentication Code b length 2 - An issuer assigned value that is retained by the terminal during the verification process of the Signed Static Application Data
    public final static String tag9F4C = "9F4C"; // ICC Dynamic Number b length 2-8 - Time-variant number generated by the ICC, to be captured by the terminal
    public final static String tag9F7C = "9F7C"; // Visa Customer Exclusive Data an VAR ..64
