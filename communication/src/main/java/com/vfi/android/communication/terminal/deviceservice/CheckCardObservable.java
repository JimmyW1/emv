...
import com.vfi.android.communication.terminal.consts.CardEntryMode;
import com.vfi.android.communication.terminal.consts.CheckCardErrorConst;
import com.vfi.android.libtools.beans.CommonException;
import com.vfi.android.libtools.consts.ExceptionType;
...
public class CheckCardObservable {
    ...
    public CheckCardObservable build(IPosServiceImpl posService) {
