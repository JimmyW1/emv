...
public class TLVUtil {
    ...
    public static List<String> getTagList(String tlvHexStr, String tagHex) {
        ...
        LogUtil.d(TAG, "tlvHexStr=[" + tlvHexStr + "] + tagHex=[" + tagHex + "]");

        if (tlvHexStr == null || tagHex == null) {
            return tagList;
        }

        List<String> tlvHexStrTagList = new ArrayList<>();
        parseTags(tlvHexStrTagList, StringUtil.hexStr2Bytes(tlvHexStr), 0);

        for (String tag : tlvHexStrTagList) {
            if (tag.startsWith(tagHex + ":")) {
    ...
    public static void parseTags(List<String> tagList, byte[] tlvStrBytes, int start) {
...
//             */
            ...
            if (isIncludeSubTag) {
                parseTags(tagList, StringUtil.hexStr2Bytes(value), 0);
            }
